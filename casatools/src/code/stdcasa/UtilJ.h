...
template <typename F, typename S>
class FirstFunctor : public std::__unary_function<std::pair<F,S>, F>{
public:
...
Example of using composer and unary.  The composed functors have to be derived from std::__unary_function
