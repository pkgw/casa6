...
#ifndef IMAGEANALYSIS_LINEARPOLARIZATIONCALCULATOR_H
#define IMAGEANALYSIS_LINEARPOLARIZATIONCALCULATOR_H
...
class LinearPolarizationCalculator : public ImagePolTask {
public:

    LinearPolarizationCalculator() = delete;
    ...
    virtual ~LinearPolarizationCalculator();
