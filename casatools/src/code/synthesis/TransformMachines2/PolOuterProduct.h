...
#ifndef SYNTHESIS_TRANSFORM2_POLOUTERPRODUCT_H
#define SYNTHESIS_TRANSFORM2_POLOUTERPRODUCT_H
...
namespace casa{
  ...
  //
    ...
    casacore::Int translateGenericToStokes2(const PolOuterProduct::GenericVBPol& gPol, 
