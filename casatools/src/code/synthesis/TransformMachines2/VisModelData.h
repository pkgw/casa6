...
// </todo>
 ...
 public:
  ...
  static void putModel(const casacore::MeasurementSet& thems,const casacore::RecordInterface& rec,
		       const casacore::Matrix<casacore::Int>& indexComb, const casacore::Matrix<casacore::Int>& chansel,
		       casacore::Bool iscomponentlist=true, casacore::Bool incremental=false);
  void putModelI(const casacore::MeasurementSet& thems,const casacore::RecordInterface& rec, const casacore::Matrix<casacore::Int>& indexComb,
  ...
  void init(const VisBuffer& /*vb*/){throw(casacore::AipsError("Called the wrong version of VisModelData"));};
 private:
