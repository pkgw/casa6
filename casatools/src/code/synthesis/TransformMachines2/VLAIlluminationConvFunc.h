...
#ifndef SYNTHESIS_TRANSFORM2_VLAILLUMINATIONCONVFUNC_H
#define SYNTHESIS_TRANSFORM2_VLAILLUMINATIONCONVFUNC_H
...
namespace casa
{
  ...
  public:
    ...
    void regridApeture(casacore::CoordinateSystem& skyCS, casacore::IPosition& skyShape, casacore::TempImage<casacore::Complex>& uvGrid, 
		       const VisBuffer2& vb,casacore::Bool doSquint=true);
    void applyPB(casacore::ImageInterface<casacore::Float>& pbImage, const VisBuffer2& vb);
    void applyPB(casacore::ImageInterface<casacore::Complex>& pbImage, const VisBuffer2& vb);
