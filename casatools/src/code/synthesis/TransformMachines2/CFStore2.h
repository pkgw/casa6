...
//#
//# $Id$
#ifndef SYNTHESIS_TRANSFORM2_CFSTORE2_H
...
namespace casa { //# NAMESPACE CASA - BEGIN
  ...
  public:
    ...
    void primeTheCFB();
    //-------------------------------------------------------------------------
    void initMaps(const VisBuffer2& vb, const casacore::Matrix<casacore::Double>& freqSelection, 
   ...
   void clear();
    ...
    void setLazyFill(const casacore::Bool& val) {lazyFillOn_p=val;}
