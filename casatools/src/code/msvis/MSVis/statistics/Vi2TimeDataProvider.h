...
//
#ifndef MSVIS_STATISTICS_VI2_TIME_DATA_PROVIDER_H_
#define MSVIS_STATISTICS_VI2_TIME_DATA_PROVIDER_H_
...
class Vi2TimeDataProvider final
...
#endif // MSVIS_STATISTICS_VI2_TIME_DATA_PROVIDER_H_
